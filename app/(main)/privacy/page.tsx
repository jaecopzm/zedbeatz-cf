  ...
  return (
    <div className="pb-8 px-4 md:px-8 pt-4 md:pt-5">
      <div className="max-w-3xl mx-auto">
        <h1 className="font-display text-2xl md:text-[32px] font-bold tracking-tight leading-tight mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-[var(--muted)] leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-lg md:text-lg md:text-2xl font-bold text-foreground mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">3. Information Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">4. Cookies and Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">7. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-foreground mb-3">9. Contact Us</h2>
            <p>
