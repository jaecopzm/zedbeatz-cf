    ...
    <div className="pb-28">
      <div className="relative overflow-hidden mb-6">
        ...
        <section className="relative px-4 md:px-8 pt-8 pb-6 flex flex-col sm:flex-row items-start sm:items-end gap-5 max-w-6xl mx-auto animate-pulse">
          <div className="w-36 h-36 md:w-48 md:h-48 overflow-hidden bg-white/5 shrink-0 shadow-[0_20px_60px_rgba(0,0,0,0.5)] ring-1 ring-white/10 flex items-center justify-center">
            <ListMusic size={48} className="text-white/15" />
          </div>
          <div className="min-w-0 flex-1">
            <div className="h-3 w-32 bg-white/10 mb-3" />
            <div className="h-10 md:h-12 w-72 md:w-[520px] max-w-full bg-white/10 mb-3" />
      ...
      <section className="relative px-2 sm:px-4 md:px-8 pb-12 max-w-6xl mx-auto">
        <div className="overflow-hidden">
          <div className="sticky top-0 z-10 grid grid-cols-[40px_1fr] sm:grid-cols-[56px_1fr_180px] gap-2 px-3 sm:px-6 py-2.5 sm:py-3 text-[11px] font-black uppercase tracking-widest text-white/40 border-b border-white/10 bg-black/80 backdrop-blur-xl">
            ...
            {Array.from({ length: 10 }).map((_, i) => (
              ...
              >
                ...
                <div className="min-w-0 flex items-center gap-3">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/10 ring-1 ring-white/10 shrink-0" />
                  <div className="min-w-0 flex-1">
