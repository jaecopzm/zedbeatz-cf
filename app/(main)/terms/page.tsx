    ...
    <div className="min-h-screen pb-32 px-4 md:px-8 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-[var(--muted)] leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-lg md:text-lg md:text-2xl font-bold text-white mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">2. Use of Service</h2>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">3. User Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">4. Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">5. Artist Content Upload</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">6. Prohibited Activities</h2>
            <p>You may not:</p>
            <ul className="list-disc list-inside space-y-2 mt-2">
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">7. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">8. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">9. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">10. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">11. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg md:text-2xl font-bold text-white mb-3">12. Contact</h2>
            <p>
