...
export default function MobileMiniplayer({
  ...
  return (
    <div className="lg:hidden fixed left-0 right-0 z-40 px-1" style={{ bottom: "calc(64px + env(safe-area-inset-bottom, 0px) - 4px)" }}>
      <div
        ...
        style={{ background: `linear-gradient(135deg, rgb(${color}) 0%, rgba(${color},0.7) 100%)`, transition: "background 0.8s ease" }}
      >
